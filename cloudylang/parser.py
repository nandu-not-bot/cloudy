...
class ReturnNode:
    def __init__(self, node_to_return: NumberNode, pos_start: Position, pos_end: Position):
...
class Parser:
    ...
    def if_expr_c(self):
        ...
        if self.current_tok.matches(TT.KEYWORD, "else"):
            ...
            if self.current_tok.type == TT.NEWLINE:
                ...
                if not self.current_tok.matches(TT.KEYWORD, "end"):
                    return res.faliure(
                        InvalidSyntaxError(
                            self.current_tok.pos_start,
                            self.current_tok.pos_end,
    ...
    def if_expr_cases(self, case_keyword):
        ...
        if self.current_tok.type == TT.NEWLINE:
            ...
            if self.current_tok.matches(TT.KEYWORD, "end"):
                res.register_advancement()
                self.advance()
            else:
